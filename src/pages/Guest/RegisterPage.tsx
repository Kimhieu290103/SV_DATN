...
//   return (
//     <div className="bg-white min-h-screen flex flex-col justify-center items-center p-4 mt-16">
//       <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6 mt-10">
//         <div className="mb-6">
//           <h1 className="font-inter text-center text-4xl font-bold text-blue-900">Đăng ký</h1>
